...
#     || OpenJDK 11 ||
#     \\------------||
#      \\-- https://archlinux.org/packages/extra/x86_64/jdk11-openjdk/
...
#     \\----------------------||
#      \\-- https://archlinux.org/packages/community/x86_64/metasploit/
...
#     || PowerSploit PowerShell library ||
#     \\--------------------------------||
